...
import fr.arinonia.valkyria.bootstrap.updater.json.Data;
import fr.arinonia.valkyria.bootstrap.updater.json.DataFile;
import fr.arinonia.valkyria.bootstrap.utils.Constants;
import fr.arinonia.valkyria.bootstrap.utils.Utils;
...
public class Updater {
    ...
    private void jsonDeserialize(String str){
        ...
        if(data.getMaintenance().isMaintenance()){
            //TODO VIRER CETTE MERDE ET METTRE UNE FENÊTRE SANS LE EXIT...
            System.out.println("peux pas lancer j'ai piscine");
            System.exit(0);
        }
